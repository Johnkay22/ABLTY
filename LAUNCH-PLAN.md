...
**Status synced:** 2026-09-11, task 0.1 written and opened as [#125](https://github.com/Johnkay22/ABLTY/pull/125), revised twice the same day (view grants + consent ownership; then per-account consent storage + the sign-in consent gate). Rollout step 1 is done: `20260911000001` and `20260911000002` are applied live. Not merged; `20260911000003` not applied.
